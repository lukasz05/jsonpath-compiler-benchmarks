    ...
    fn new_ondemand() -> Result<Self, JsonPathCompilerError> {
        Ok(JsonPathCompilerCore {
            query_functions: HashMap::from([
                ...
                ("$[?(@.id == 787994024502190080)].entities.user_mentions[0].screen_name", ondemand_status_with_id_screen_name_large as QueryFunction),
                ("$.statuses[?(@.id == 505874873961308160)]..*", ondemand_status_with_id_descendants as QueryFunction),
                ("$[?(@.id == 787994024502190080)]..*", ondemand_status_with_id_descendants_large as QueryFunction),
    ...
    fn new_ondemand_eager_filters() -> Result<Self, JsonPathCompilerError> {
        Ok(JsonPathCompilerCore {
            query_functions: HashMap::from([
                ...
                ("$[?(@.id == 787994024502190080)].entities.user_mentions[0].screen_name", ondemand_eager_filters_status_with_id_screen_name_large as QueryFunction),
                ("$.statuses[?(@.id == 505874873961308160)]..*", ondemand_eager_filters_status_with_id_descendants as QueryFunction),
                ("$[?(@.id == 787994024502190080)]..*", ondemand_eager_filters_status_with_id_descendants_large as QueryFunction),
